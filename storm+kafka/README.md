...
This example illustrates how to:
    ...
    * push messages into Kafka and retrieves those messages with a Kafka/Storm bolt.
...
with messages sent (lines 22-26, below.) 
...
instance at port 2000 (which LocalCluster seems to insist on kicking off itself). This the same zookeeper
